...
upper_bound = 1000000
lower_bound = int(upper_bound / 2) # Any number N less than half the limit would be bested by 2N
path_lengths = [collatz_length(x, collatz_length_cache) for x in range(lower_bound, upper_bound)]
